...
var $th=$(this);
var info_="";
if($th.attr("title")) info_=$th.attr("title"); else info_=$th.text();
$th.html("<div class='gridCol' title='"+info_+"'>"+$th.html()+"</div>");});
ths.each(function(i){
...
if(form){
if(args["pageNum"])form["page"].value=args["pageNum"];
if(args["numPerPage"])form["pageSize"].value=args["numPerPage"];
